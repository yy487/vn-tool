...
面向 `sayonara用的` 的工具目录，上级分类为 `scrplay`。
...
| 文件 | 定位 | 说明 |
|---|---|---|
| `scr_extract.py` | 提取/解析 | Interlude Engine SCR Script — Text Extractor ============================================= Target: インタールード (Interlude) / さよならを教えて etc. Format: SCR:0001 Output: GalTransl-compatible |
| `scr_inject.py` | 注入/回写 | Interlude Engine SCR Script — Text Injector ============================================ Target: インタールード (Interlude) / さよならを教えて etc. Format: SCR:0001 Rebuilds text area from transl |
